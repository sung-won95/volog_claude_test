...
### 🆕 4. 실시간 연습 모드 (NEW!)
- **실시간 녹음**: 실제 마이크 입력으로 즉시 분석
- **실시간 피드백**: 0.5초마다 구체적 조언 제공
- **실시간 시각화**: 음정, 음량, 정확도 실시간 그래프
- **즉석 교정**: 발성 문제를 즉시 인식하고 개선 가능
...
실제 마이크를 사용한 실시간 보컬 코칭이 가능합니다!

### 설치 (실시간 기능용)
```bash
pip install sounddevice  # 실시간 마이크 입력
```

### 실시간 모드 특징
- ✨ **즉시 피드백**: 노래하는 동안 실시간으로 조언 제공
- 📊 **실시간 시각화**: 음정, 음량, 정확도 그래프 실시간 표시
- 🎯 **목표 비교**: 원곡 멜로디와 실시간 비교
- 💡 **스마트 조언**: AI가 개인별 문제점 파악하여 맞춤 피드백

### 사용법
1. 메인 메뉴에서 "3. 실시간 연습 모드" 선택
2. 연습할 구간 선택
3. 마이크 설정 확인
4. 실시간으로 노래하며 즉시 피드백 받기!

> 📖 **상세 가이드**: [REALTIME_GUIDE.md](REALTIME_GUIDE.md) 참조
...
#### 웹 버전 특징
- 🎤 **브라우저 녹음**: 별도 소프트웨어 없이 웹에서 바로 녹음
- 📊 **실시간 시각화**: 차트와 그래프로 결과 확인
- 🎯 **직관적 UI**: 단계별 가이드로 쉬운 사용
- 📱 **반응형 디자인**: 모바일에서도 사용 가능

#### 웹 사용 과정
1. **노래 업로드**: MP3, WAV 등 오디오 파일 드래그 앤 드롭
2. **AI 분석**: 자동으로 연습 구간 생성 (30초 내외)
3. **구간 선택**: 연습하고 싶은 구간 클릭
4. **브라우저 녹음**: 마이크 권한 허용 후 녹음 버튼 클릭
5. **즉시 분석**: 녹음 완료 즉시 AI 분석 결과 표시
